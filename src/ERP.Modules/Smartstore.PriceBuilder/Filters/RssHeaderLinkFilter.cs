...
namespace Smartstore.PriceBuilder.Filters
{
    public class RssHeaderLinkFilter : IResultFilter
    {
        ...
        public RssHeaderLinkFilter(PriceBuilderSettings blogSettings, IWidgetProvider widgetProvider, IStoreContext storeContext, Lazy<IUrlHelper> urlHelper, Lazy<IWebHelper> webHelper)
        {
